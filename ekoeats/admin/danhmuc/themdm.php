                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> Thêm Loại Hàng Hóa</a></li>
                                </ul>
                                           ...
                                           <form action="index.php?act=themdm" method="POST">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <span style="color:red"><?=$errortenloai?></span>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds">
                                                    <input class="btn btn-ctl-bt waves-effect waves-light m-r-10" type="submit" value="THÊM MỚI" name="themmoi">
